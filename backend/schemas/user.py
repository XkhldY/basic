...
class AdvancedCandidateProfileUpdate(BaseModel):
    ...
    # Personal & Contact
    phone_number: Optional[str] = None
    date_of_birth: Optional[str] = None  # Changed from date to str for flexibility
    location: Optional[str] = None
    linkedin_url: Optional[str] = None
    github_url: Optional[str] = None
    ...
    education_level: Optional[str] = None
    years_of_experience: Optional[str] = None  # Changed from int to str for flexibility
    current_salary: Optional[str] = None  # Changed from int to str for flexibility
    expected_salary: Optional[str] = None  # Changed from int to str for flexibility
    preferred_work_type: Optional[str] = None
    willing_to_relocate: Optional[bool] = None
    notice_period: Optional[str] = None
    
    # Skills & Expertise
    technical_skills: Optional[Union[List[str], str]] = None  # Accept both list and string
    soft_skills: Optional[Union[List[str], str]] = None  # Accept both list and string
    certifications: Optional[Union[List[str], str]] = None  # Accept both list and string
    languages: Optional[Union[List[str], str]] = None  # Accept both list and string
    
    # Work Preferences
    desired_industries: Optional[Union[List[str], str]] = None  # Accept both list and string
    work_schedule_preference: Optional[str] = None
    remote_work_preference: Optional[str] = None
    travel_willingness: Optional[str] = None
