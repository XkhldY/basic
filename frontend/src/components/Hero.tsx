            ...
            >
              ...
              >
                {features.map((feature) => (
                  <div
                    key={feature.text}
                    className="flex items-center space-x-2 text-gray-700 dark:text-gray-200 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm px-4 py-2 rounded-xl border border-white/20 dark:border-gray-700/20 shadow-lg"
                  >
