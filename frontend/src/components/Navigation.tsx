    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] transform ${
      ...
      <nav className="container-custom">
        <div className="hidden md:grid grid-cols-3 items-center h-20">
          ...
          >
            <Link href="/" className="flex items-center space-x-3 group focus:outline-none focus:ring-0 focus:border-0 focus:shadow-none focus:ring-offset-0" style={{ outline: 'none', WebkitTapHighlightColor: 'transparent' }}>
              <motion.div 
                className="relative"
              >
                <img
      ...
      <div className={`md:hidden flex items-center justify-between h-20 transition-all duration-300 px-4 sm:px-6 lg:px-8 ${
