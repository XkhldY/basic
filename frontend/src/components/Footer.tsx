...
import { Heart, Mail, MessageSquare, ArrowUp, Linkedin } from 'lucide-react'
...
const Footer = () => {
  ...
  const socialLinks = [
    { name: 'LinkedIn', href: 'https://www.linkedin.com/company/hirewithpom/', icon: <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg> }
  ]
  ...
  return (
    <footer className="bg-gray-900 dark:bg-gray-950 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-l from-accent-900/20 to-transparent rounded-full opacity-25 blur-3xl"></div>
         ...
         <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 py-8 sm:py-12">
            ...
            >
                 ...
                 <img
                   ...
                   alt="POM Logo"
                   className="w-12 h-12 sm:w-16 sm:h-16 object-contain -mt-4"
                 />
               </div>
                             <p className="text-gray-300 dark:text-gray-400 mb-2 max-w-md leading-relaxed text-xs sm:text-sm -mt-3">
            ...
            >
               ...
               <div className="space-y-2 sm:space-y-3 mb-0 sm:mb-0">
                 <a 
                   ...
                   className="flex items-center space-x-3 text-gray-300 dark:text-gray-400 hover:text-white transition-colors duration-200 focus:outline-none focus:ring-0 focus:border-0 focus:shadow-none focus:ring-offset-0 focus:ring-offset-transparent cursor-pointer"
                   style={{ outline: 'none', WebkitTapHighlightColor: 'transparent' }}
                   title="Open Gmail to send us an email"
                 >
                   <Mail size={16} className="text-[#ffc759]" />
                   <span className="text-xs sm:text-sm">info@hirewithpom.com</span>
                 </a>
                 <a 
                   href="https://www.linkedin.com/company/hirewithpom/"
                   target="_blank"
          ...
          {/* Bottom Section */}
          <div className="border-t border-gray-800 dark:border-gray-700 py-4 sm:py-6">
      ...
      <motion.button
        onClick={scrollToTop}
        className="fixed bottom-6 right-6 sm:bottom-8 sm:right-8 w-10 h-10 sm:w-12 sm:h-12 bg-primary-600 hover:bg-primary-700 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group z-50"
        ...
        whileTap={{ scale: 0.9 }}
      >
        <ArrowUp size={16} className="sm:w-5 sm:h-5 group-hover:-translate-y-1 transition-transform duration-200" />
      </motion.button>
    </footer>
  )
}
